!(function (e, t) {
  ...
  const t = "single-file-load-deferred-images-start",
    ...
    g = "_singleFile_fontFaces",
    p = (e, t, s) => globalThis.addEventListener(e, t, s),
    h = (e) => {
      try {
        globalThis.dispatchEvent(e);
      } catch (e) {}
    },
    f = globalThis.CustomEvent,
    T = globalThis.document,
    E = globalThis.Document,
    b = globalThis.JSON;
  let y;
  (y = window[g] ? window[g] : (window[g] = new Map())),
    T instanceof E &&
      (p("single-file-new-font-face", (e) => {
        const t = e.detail,
          s = Object.assign({}, t);
        delete s.src, y.set(b.stringify(s), t);
      }),
      p("single-file-delete-font", (e) => {
        const t = e.detail,
          s = Object.assign({}, t);
        delete s.src, y.delete(b.stringify(s));
      }),
      p("single-file-clear-fonts", () => (y = new Map())));
  const I = "[\\x20\\t\\r\\n\\f]",
    w = new RegExp("\\\\([\\da-f]{1,6}" + I + "?|(" + I + ")|.)", "ig");
  const A = "single-file-",
    S = "_singleFile_waitForUserScript",
    v = "__frameTree__::",
    R = A + "on-before-capture",
    N = A + "on-after-capture",
    P = A + "request-get-adopted-stylesheets",
    _ = A + "response-get-adopted-stylesheets",
    C = A + "unregister-request-get-adopted-stylesheets",
    M = A + "user-script-init",
    ...
    return (
      t && e.documentElement
        ? (e.querySelectorAll("button button, a a").forEach((t) => {
          ...
          (n = de(t, e, e.documentElement, s)),
          s.moveStylesInHead &&
            e.querySelectorAll("body style, body ~ style").forEach((e) => {
              const s = Ee(t, e);
              s &&
                pe(e, s) &&
                (e.setAttribute(W, ""), n.markedElements.push(e));
            }))
        : (n = {
            canvases: [],
            images: [],
          ...
          }),
      {
        ...
        adoptedStyleSheets: ce(e.adoptedStyleSheets),
      }
    );
  }
  function de(
      ...
      Array.from(s.childNodes)
        ...
        .forEach((s) => {
          ...
          if (
            ...
            o.removeUnusedFonts &&
              (me(l, o, n.usedFonts),
              me(Ee(e, s, ":first-letter"), o, n.usedFonts),
              me(Ee(e, s, ":before"), o, n.usedFonts),
              me(Ee(e, s, ":after"), o, n.usedFonts));
          }
          ...
          if (d && !s.classList.contains(se) && s.tagName.toLowerCase() != oe) {
            ...
            try {
              if (d.adoptedStyleSheets)
                if (d.adoptedStyleSheets.length)
                  a.adoptedStyleSheets = ce(d.adoptedStyleSheets);
            ...
            de(e, t, d, o, n, i), (a.content = d.innerHTML), (a.mode = d.mode);
            try {
              d.adoptedStyleSheets &&
                void 0 === d.adoptedStyleSheets.length &&
                d.dispatchEvent(new re(C, { bubbles: !0 }));
            } catch (e) {}
          }
          de(e, t, s, o, n, i),
            !o.autoSaveExternalSave &&
  ...
  const be = { LAZY_SRC_ATTRIBUTE_NAME: Y, SINGLE_FILE_UI_ELEMENT_CLASS: se },
    ye = 10,
    Ie = "attributes",
    we = globalThis.browser,
    Ae = globalThis.document,
    Se = globalThis.MutationObserver,
    ve = (e, t, s) => globalThis.addEventListener(e, t, s),
    Re = (e, t, s) => globalThis.removeEventListener(e, t, s),
    Ne = new Map();
  let Pe;
  async function _e(e) {
    if (Ae.documentElement) {
      Ne.clear();
      const s = Ae.body
          ? Math.max(Ae.body.scrollHeight, Ae.documentElement.scrollHeight)
          : Ae.documentElement.scrollHeight,
        n = Ae.body
          ? Math.max(Ae.body.scrollWidth, Ae.documentElement.scrollWidth)
          : Ae.documentElement.scrollWidth;
          ...
          return (function (e) {
            return (
              ...
              new Promise(async (s) => {
                ...
                const i = new Set(),
                  l = new Se(async (t) => {
                    if ((t = t.filter((e) => e.type == Ie)).length) {
                      t.filter((e) => {
                        if (
                          ("src" == e.attributeName &&
                            (e.target.setAttribute(
                              be.LAZY_SRC_ATTRIBUTE_NAME,
                              e.target.src
                            ),
                            e.target.addEventListener("load", g)),
                          "src" == e.attributeName ||
                          ...
                          return (
                            ...
                            !e.target.classList.contains(
                              be.SINGLE_FILE_UI_ELEMENT_CLASS
                            )
                          );
                      }).length &&
                        ((n = !0),
                        await Me(l, e, E),
                        i.size || (await Ce(l, e, E)));
                    }
                  });
                async function c(t) {
                  await Le(
                    ...
                    async () => {
                      n
                        ...
                        : (xe("loadTimeout"), xe("maxTimeout"), Oe(l, e, E));
                    },
                    t,
                ...
                function g(e) {
                  const t = e.target;
                  t.removeAttribute(be.LAZY_SRC_ATTRIBUTE_NAME),
                ...
                function E(e) {
                  l.disconnect(), Re(m, p), Re(u, T), s(e);
                }
                await c(2 * e.loadDeferredImagesMaxIdleTime),
                  await Me(l, e, E),
                  l.observe(Ae, { subtree: !0, childList: !0, attributes: !0 }),
                  ve(m, p),
                  ve(u, T),
                  (function (e) {
                    e.loadDeferredImagesBlockCookies && h(new f(a)),
                      e.loadDeferredImagesBlockStorage && h(new f(d)),
                      e.loadDeferredImagesDispatchScrollEvent && h(new f(r)),
  ...
  async function Me(e, t, s) {
    await Le(
      "maxTimeout",
      async () => {
        await xe("loadTimeout"), await Oe(e, t, s);
      },
  ...
  async function Oe(e, t, o) {
    await xe("idleTimeout"),
      (function (e) {
        e.loadDeferredImagesBlockCookies && h(new f(i)),
          e.loadDeferredImagesBlockStorage && h(new f(c)),
          e.loadDeferredImagesDispatchScrollEvent && h(new f(l)),
          e.loadDeferredImagesKeepZoomLevel ? h(new f(n)) : h(new f(s));
      })(t),
      await Le(
        "endTimeout",
        async () => {
          await xe("maxTimeout"), o();
        },
  ...
  async function Le(e, t, s, o) {
    if (we && we.runtime && we.runtime.sendMessage && !o) {
      if (!Ne.get(e) || !Ne.get(e).pending) {
        const o = { callback: t, pending: !0 };
        Ne.set(e, o);
        try {
          await we.runtime.sendMessage({
  ...
  function De(e, t, s) {
    const o = Ne.get(e);
    o && globalThis.clearTimeout(o), Ne.set(e, t), globalThis.setTimeout(t, s);
  }
  async function xe(e) {
    if (we && we.runtime && we.runtime.sendMessage)
      try {
        await we.runtime.sendMessage({
  ...
  const Ue = {
      ...
      WAIT_FOR_USERSCRIPT_PROPERTY_NAME: S,
      preProcessDoc: le,
    ...
    qe = 'iframe, frame, object[type="text/html"][data]',
    ke = "*",
    He = "singlefile.frameTree.initRequest",
    Ve = "singlefile.frameTree.ackInitRequest",
    Be = "singlefile.frameTree.cleanupRequest",
    We = "singlefile.frameTree.initResponse",
    ze = "*",
    Ye = 5e3,
    je = ".",
  ...
  async function at(e) {
    const t = e.sessionId,
      s = globalThis[Ue.WAIT_FOR_USERSCRIPT_PROPERTY_NAME];
    delete globalThis._singleFile_cleaningUp,
      Ge || (Qe = globalThis.frameId = e.windowId),
      lt(Je, e.options, Qe, t),
      Ge ||
        (e.options.userScriptEnabled &&
          s &&
          (await s(Ue.ON_BEFORE_CAPTURE_EVENT_NAME)),
        ut({
          frames: [pt(Je, globalThis, Qe, e.options, e.scrolling)],
          sessionId: t,
          requestedFrameId: Je.documentElement.dataset.requestedFrameId && Qe,
        }),
        e.options.userScriptEnabled &&
          s &&
          (await s(Ue.ON_AFTER_CAPTURE_EVENT_NAME)),
  ...
  function it(e) {
    if (!globalThis._singleFile_cleaningUp) {
      ...
      const t = e.sessionId;
      mt(ht(Je), e.windowId, t);
    }
  }
  function rt(e) {
    e.frames.forEach((t) => dt("responseTimeouts", e.sessionId, t.windowId));
    const t = et.get(e.sessionId);
    if (t) {
  ...
  function lt(e, t, s, o) {
    ...
    !(function (e, t, s, o, n) {
      ...
      let i;
      et.get(n)
        ? (i = et.get(n).requestTimeouts)
        : ((i = {}), et.set(n, { requestTimeouts: i }));
      t.forEach((e, t) => {
        const s = o + je + t;
        e.setAttribute(Ue.WIN_ID_ATTRIBUTE_NAME, s), a.push({ windowId: s });
      }),
        ut({
          frames: a,
          sessionId: n,
        ...
        t.forEach((e, t) => {
          ...
          i[a] = globalThis.setTimeout(
            () =>
              ut({ frames: [{ windowId: a, processed: !0 }], sessionId: n }),
            Ye
          );
        }),
  ...
  function ct(e, t) {
    ...
    s &&
      ...
      (s.responseTimeouts[t] = globalThis.setTimeout(
        () => ut({ frames: [{ windowId: t, processed: !0 }], sessionId: e }),
        1e4
      ));
  }
  function mt(e, t, s) {
    e.forEach((e, o) => {
      const n = t + je + o;
      e.removeAttribute(Ue.WIN_ID_ATTRIBUTE_NAME);
      try {
        gt(e.contentWindow, { method: Be, windowId: n, sessionId: s });
      } catch (e) {}
    }),
      e.forEach((e, o) => {
        const n = t + je + o;
  ...
  function gt(e, t, s) {
    if (e == Xe && Ke && Ke.runtime && Ke.runtime.sendMessage)
      ...
      const s = new Ze();
      e.postMessage(
        v + $e.stringify({ method: t.method, sessionId: t.sessionId }),
        ze,
        [s.port2]
      ),
        s.port1.postMessage(t);
    } else e.postMessage(v + $e.stringify(t), ze);
  }
  function pt(e, t, s, o, n) {
    const a = Ue.preProcessDoc(e, t, o),
      i = Ue.serialize(e);
    Ue.postProcessDoc(e, a.markedElements, a.invalidElements);
    return {
      windowId: s,
      content: i,
  ...
  function ht(e) {
    let t = Array.from(e.querySelectorAll(qe));
    return (
      e.querySelectorAll(ke).forEach((e) => {
        const s = Ue.getShadowRoot(e);
        s && (t = t.concat(...s.querySelectorAll(qe)));
      }),
      t
    );
  }
  et || (et = globalThis.sessions = new Map()),
    Ge &&
      ((Qe = "0"),
      Ke &&
        Ke.runtime &&
        ...
        Ke.runtime.onMessage.addListener((e) =>
          e.method == We
            ? (rt(e), Promise.resolve({}))
            : e.method == Ve
            ? (dt("requestTimeouts", e.sessionId, e.windowId),
              ct(e.sessionId, e.windowId),
              Promise.resolve({}))
            : void 0
        )),
    (tt = "message"),
    (st = async (e) => {
      if ("string" == typeof e.data && e.data.startsWith(v)) {
        e.preventDefault(), e.stopPropagation();
        const t = $e.parse(e.data.substring(v.length));
        t.method == He
          ? (e.source &&
              gt(e.source, {
                method: Ve,
            ...
            Ge ||
              (globalThis.stop(),
              t.options.loadDeferredImages && _e(t.options),
              await at(t)))
          : t.method == Ve
          ? (dt("requestTimeouts", t.sessionId, t.windowId),
            ct(t.sessionId, t.windowId))
          : t.method == Be
          ? it(t)
          : t.method == We &&
            et.get(t.sessionId) &&
            (e.ports[0].onmessage = (e) => rt(e.data));
      }
    }),
    (ot = !0),
    globalThis.addEventListener(tt, st, ot);
      ...
      return (
        ...
        new Promise((s) => {
          et.set(t, {
            ...
            at({ windowId: Qe, sessionId: t, options: e });
        })
      );
    },
    getSync: function (e) {
      const t = nt();
      (e = $e.parse($e.stringify(e))),
        et.set(t, { frames: [], requestTimeouts: {}, responseTimeouts: {} }),
        (function (e) {
          const t = e.sessionId,
            s = globalThis[Ue.WAIT_FOR_USERSCRIPT_PROPERTY_NAME];
          delete globalThis._singleFile_cleaningUp,
          ...
          lt(Je, e.options, Qe, t),
            Ge ||
              (e.options.userScriptEnabled &&
                s &&
                s(Ue.ON_BEFORE_CAPTURE_EVENT_NAME),
              ut({
                frames: [pt(Je, globalThis, Qe, e.options, e.scrolling)],
                sessionId: t,
                requestedFrameId:
                  Je.documentElement.dataset.requestedFrameId && Qe,
              }),
              e.options.userScriptEnabled &&
                s &&
                s(Ue.ON_AFTER_CAPTURE_EVENT_NAME),
              delete Je.documentElement.dataset.requestedFrameId);
        })({ windowId: Qe, sessionId: t, options: e });
      const s = et.get(t).frames;
      return (s.sessionId = t), s;
    },
    cleanup: function (e) {
      et.delete(e),
        it({ windowId: Qe, sessionId: e, options: { sessionId: e } });
    },
    initResponse: rt,
    TIMEOUT_INIT_REQUEST_MESSAGE: Ye,
  });
  const Tt = [
      "AREA",
      "BASE",
    ...
    It = [
      {
        tagName: "HEAD",
        accept: (e) => !e.childNodes.length || e.childNodes[0].nodeType == Et,
      },
      { tagName: "BODY", accept: (e) => !e.childNodes.length },
    ],
    wt = [
      { tagName: "HTML", accept: (e) => !e || e.nodeType != yt },
      {
        tagName: "HEAD",
        accept: (e) =>
          !e || (e.nodeType != yt && (e.nodeType != bt || !vt(e.textContent))),
      },
      { tagName: "BODY", accept: (e) => !e || e.nodeType != yt },
      {
        tagName: "LI",
        accept: (e, t) =>
          (!e &&
            t.parentElement &&
            ("UL" == Rt(t.parentElement) || "OL" == Rt(t.parentElement))) ||
          (e && ["LI"].includes(Rt(e))),
      },
      { tagName: "DT", accept: (e) => !e || ["DT", "DD"].includes(Rt(e)) },
      {
        tagName: "P",
        accept: (e) =>
          e &&
      ...
      { tagName: "DD", accept: (e) => !e || ["DT", "DD"].includes(Rt(e)) },
      { tagName: "RT", accept: (e) => !e || ["RT", "RP"].includes(Rt(e)) },
      { tagName: "RP", accept: (e) => !e || ["RT", "RP"].includes(Rt(e)) },
      {
        tagName: "OPTGROUP",
        accept: (e) => !e || ["OPTGROUP"].includes(Rt(e)),
      },
      {
        tagName: "OPTION",
        accept: (e) => !e || ["OPTION", "OPTGROUP"].includes(Rt(e)),
      },
      {
        tagName: "COLGROUP",
        accept: (e) =>
      ...
      {
        tagName: "THEAD",
        accept: (e) => !e || ["TBODY", "TFOOT"].includes(Rt(e)),
      },
      {
        tagName: "TBODY",
        accept: (e) => !e || ["TBODY", "TFOOT"].includes(Rt(e)),
      ...
      { tagName: "TR", accept: (e) => !e || ["TR"].includes(Rt(e)) },
      { tagName: "TD", accept: (e) => !e || ["TD", "TH"].includes(Rt(e)) },
      { tagName: "TH", accept: (e) => !e || ["TD", "TH"].includes(Rt(e)) },
    ],
    At = [
      "STYLE",
      "SCRIPT",
  ...
  function St(e, t, s) {
    return e.nodeType == bt
      ? (function (e) {
          ...
          let s;
          t && t.nodeType == Et && (s = Rt(t));
          return !s || At.includes(s)
            ? "SCRIPT" == s || "STYLE" == s
      ...
      ? (function (e, t, s) {
          const o = Rt(e),
            n = t && It.find((t) => o == Rt(t) && t.accept(e));
          let a = "";
          ...
          "TEMPLATE" != o || e.childNodes.length
            ...
            : (a += e.innerHTML);
          const i =
            t && wt.find((t) => o == Rt(t) && t.accept(e.nextSibling, e));
          (s || (!i && !Tt.includes(o))) && (a += "</" + o.toLowerCase() + ">");
          return a;
        })(e, t, s)
      : void 0;
  }
